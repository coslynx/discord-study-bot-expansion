...
const userService = {
  ...
  async updateStreak(userId) {
    try {
      ...
      if (user.lastActiveDate && currentDate.getDate() === user.lastActiveDate.getDate() && currentDate.getMonth() === user.lastActiveDate.getMonth() && currentDate.getFullYear() === user.lastActiveDate.getFullYear()) {
        // Streak continues
        user.streak += 1;
